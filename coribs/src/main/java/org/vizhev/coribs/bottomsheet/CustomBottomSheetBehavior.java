package org.vizhev.coribs.bottomsheet;
...
public class CustomBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public abstract static class BottomSheetCallback {
         ...
         *     #STATE_SETTLING}, {@link #STATE_EXPANDED},{@link
         *     #STATE_HIDDEN}.
         */
    ...
    private static final float HIDE_FRICTION = 0.5f;
    ...
    public CustomBottomSheetBehavior(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        if (VERSION.SDK_INT >= VERSION_CODES.LOLLIPOP) {
            this.elevation = a.getDimension(com.google.android.material.R.styleable.BottomSheetBehavior_Layout_android_elevation, -1);
        }
        ...
        setGestureInsetBottomIgnored(
                a.getBoolean(com.google.android.material.R.styleable.BottomSheetBehavior_Layout_gestureInsetBottomIgnored, false));
        setFitToContents(
        ...
        setDraggable(a.getBoolean(com.google.android.material.R.styleable.BottomSheetBehavior_Layout_behavior_draggable, true));
        setSaveFlags(a.getInt(com.google.android.material.R.styleable.BottomSheetBehavior_Layout_behavior_saveFlags, SAVE_NONE));

        value = a.peekValue(com.google.android.material.R.styleable.BottomSheetBehavior_Layout_behavior_expandedOffset);
        if (value != null && value.type == TypedValue.TYPE_FIRST_INT) {
            setExpandedOffset(value.data);
        } else {
            setExpandedOffset(
                    a.getDimensionPixelOffset(
                            com.google.android.material.R.styleable.BottomSheetBehavior_Layout_behavior_expandedOffset, 0));
        }
        a.recycle();
     ...
     * animation.
     *
     * @param state One of {@link #STATE_EXPANDED}, {@link #STATE_HIDDEN}
     */
    ...
    private void createMaterialShapeDrawable(
        ...
        if (this.shapeThemingEnabled) {
            this.shapeAppearanceModelDefault =
                    ShapeAppearanceModel.builder(context, attrs, com.google.android.material.R.attr.bottomSheetStyle, DEF_STYLE_RES)
                            .build();
...
//                        }
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        /**
         * This constructor does not respect flags: {@link CustomBottomSheetBehavior#SAVE_PEEK_HEIGHT}, {@link
         * CustomBottomSheetBehavior#SAVE_FIT_TO_CONTENTS}, {@link CustomBottomSheetBehavior#SAVE_HIDEABLE}, {@link
         * CustomBottomSheetBehavior#SAVE_SKIP_COLLAPSED}. It is as if {@link CustomBottomSheetBehavior#SAVE_NONE}
         * were set.
         */
        @Deprecated
